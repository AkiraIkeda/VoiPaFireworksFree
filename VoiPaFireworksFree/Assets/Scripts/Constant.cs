...
public class Constant{
    ...
    public const string TAG_RISING_UPDATING = "RisingUpdating";
    public const string TAG_BOTAN_STAR_STANBY = "BotanStarStanby";
    public const string TAG_BOTAN_STAR_UPDATING = "BotanStarUpdating";
    public const string TAG_KIKU_STAR_STANBY = "KikuStarStanby";
    public const string TAG_KIKU_STAR_UPDATING = "KikuStarUpdating";
    public const string TAG_YASHI_STAR_STANBY = "YashiStarStanby";
    public const string TAG_YASHI_STAR_UPDATING = "YashiStarUpdating";
    public const string TAG_KAMURO_STAR_STANBY = "KamuroStarStanby";
    public const string TAG_KAMURO_STAR_UPDATING = "KamuroStarUpdating";
    public const string TAG_YANAGI_STAR_STANBY = "YanagiStarStanby";
    public const string TAG_YANAGI_STAR_UPDATING = "YanagiStarUpdating";
    // Senrin Star Tag
    public const string TAG_BOTANSENRIN_STANBY = "BotanSenrinStanby";
    public const string TAG_BOTANSENRIN_UPDATING = "BotanSenrinUpdating";
    public const string TAG_KIKUSENRIN_STANBY = "KikuSenrinStanby";
    public const string TAG_KIKUSENRIN_UPDATING = "KikuSenrinUpdating";
    public const string TAG_YASHISENRIN_STANBY = "YashiSenrinStanby";
    public const string TAG_YASHISENRIN_UPDATING = "YashiSenrinUpdating";
    public const string TAG_KAMUROSENRIN_STANBY = "KamuroSenrinStanby";
    public const string TAG_KAMUROSENRIN_UPDATING = "KamuroSenrinUpdating";
    public const string TAG_YANAGISENRIN_STANBY = "YanagiSenrinStanby";
    public const string TAG_YANAGISENRIN_UPDATING = "YanagiSenrinUpdating";
    public const string TAG_HACHISENRIN_STANBY = "HachiSenrinStanby";
    public const string TAG_HACHISENRIN_UPDATING = "HachiSenrinUpdating";
    // GroundStarTag
    public const string TAG_TORA_STAR_STANBY = "ToraStarStanby";
    public const string TAG_TORA_STAR_UPDATING = "ToraStarUpdating";
    public const string TAG_VTORA_STAR_STANBY = "VToraStarStanby";
    public const string TAG_VTORA_STAR_UPDATING = "VToraStarUpdating";
    public const string TAG_KIKUTORA_STAR_STANBY = "KikuToraStarStanby";
    public const string TAG_KIKUTORA_STAR_UPDATING = "KikuToraStarUpdating";
    public const string TAG_YASHITORA_STAR_STANBY = "YashiToraStarStanby";
    public const string TAG_YASHITORA_STAR_UPDATING = "YashiToraStarUpdating";
    public const string TAG_SAZANAMI_STAR_STANBY = "SazanamiStarStanby";
    public const string TAG_SAZANAMI_STAR_UPDATING = "SazanamiStarUpdating";
    public const string TAG_HIYU_STAR_STANBY = "HiyuStarStanby";
    public const string TAG_HIYU_STAR_UPDATING = "HiyuStarUpdating";
    public const string TAG_SENRIN_STAR_STANBY = "SenrinStarStanby";
    public const string TAG_SENRIN_STAR_UPDATING = "SenrinStarUpdating";
    public const string TAG_RANDAMA_STAR_STANBY = "RandamaStarStanby";
    public const string TAG_RANDAMA_STAR_UPDATING = "RandamaStarUpdating";
}
